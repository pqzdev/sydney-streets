#!/usr/bin/env python3
"""
Process the full Melbourne roads dataset using Grid 200m + Highway-Aware method.
...
def count_street_instances(street_name, features, grid_size_meters=200):
    ...
    # At Melbourne's latitude, 1 degree ≈ 111km = 111000m
...
if __name__ == '__main__':
    input_file = 'data/melbourne-roads-osm.geojson'
    output_file = 'data/melbourne_street_counts_grid200.json'
